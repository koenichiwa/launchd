...
impl Launchd {
    ...
    /// Sets the label variable for the `Launchd` instance and returns the modified instance.
    ...
    /// Sets the program variable for the `Launchd` instance and returns the modified instance.
